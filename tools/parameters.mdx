...
| **Required**      | N/A      | If checked, the AI must always provide this parameter.                      |
| **Default value** | N/A      | Used when the parameter is not required and the AI doesn't provide it.      |
