...
<Frame>
  ![Screenshot 16](/images/screenshots/tool-run-panel.png)
</Frame>
...
<Steps>
  ...
  <Step title="Fill in parameters">
    ...
    <Frame>
      ![Screenshot 17](/images/screenshots/tool-run-params.png)
    </Frame>
  </Step>
  ...
  <Step title="Inspect the result">
    ...
    <Frame>
      ![Screenshot 18](/images/screenshots/tool-run-result.png)
    </Frame>
  </Step>
</Steps>
