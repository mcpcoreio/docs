...
<Steps>
  <Step title="Open the Secrets tab">
    ...
    <Frame>
      <img src="/images/screenshots/secrets-tab.png" alt="Secrets tab showing existing secrets" />
    </Frame>
  </Step>
  ...
  <Step title="Enter the key and value">
    ...
    <Frame>
      <img src="/images/screenshots/secrets-add-form.png" alt="Add secret form with key and value fields" />
    </Frame>
  </Step>
  <Step title="Save">
