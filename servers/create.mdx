...
<Steps>
  <Step title="Navigate to My Servers">
    ...
    <Frame>
      ![Image 1](/images/screenshots/server-create-button.png)
    </Frame>
  </Step>
  <Step title="Fill in the server details">
    ...
    <Frame>
      ![Screenshot 7](/images/screenshots/server-create-form.png)
    </Frame>
  </Step>
...
<Frame>
  ![Screenshot 8](/images/screenshots/server-detail-page.png)
</Frame>
