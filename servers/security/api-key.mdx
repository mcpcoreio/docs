---
title: "API Key Mode"
description: "Clients authenticate by including a long-lived token in the Authorization header."
---
...
MCPCore generates the key for you when you select this mode. The key is shown once at creation — store it securely. It remains valid until you explicitly revoke it; there is no automatic expiry.
...
<Steps>
  ...
  <Step title="Select API Key">
    ...
    <Frame>
      <img src="/images/screenshots/security-apikey-settings.png" alt="API Key security mode selected with generated key" />
    </Frame>
  </Step>
