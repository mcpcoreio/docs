---
title: "Introduction"
description: "MCPCore is the fastest way to build, deploy, and manage MCP servers, with no infrastructure required."
---

## What is MCPCore?

**MCPCore** is a managed platform for the [Model Context Protocol (MCP)](https://modelcontextprotocol.io). It lets you write tool logic in JavaScript and get a live, MCP-compliant endpoint in under 30 seconds, with no Docker, no servers, and no `node_modules`.

MCPCore currently implements MCP specification version **2026-07-28**, the current stable release of the protocol.
...
- **Professional code editor**, a VS Code-style editor with syntax highlighting, AI-powered completions, and an integrated terminal
...
- **Encrypted secrets**, store API keys and credentials securely, referenced in code as `env.MY_KEY`
