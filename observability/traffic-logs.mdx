...
<Frame>
  <img src="/images/screenshots/traffic-logs-list.png" alt="Traffic Logs list showing recent requests with status indicators" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/traffic-log-detail.png" alt="Traffic log detail modal showing input params, output, duration, and console logs" />
</Frame>
...
<Frame>
  <img src="/images/screenshots/traffic-logs-filters.png" alt="Traffic Logs filter bar" />
</Frame>
...
Use the [Run panel](/tools/testing) to fire test calls. These appear in Traffic Logs with source `dashboard-run` so you can compare the actual output against your expectations.

**Understanding which tools the AI calls most:**
Use the [Analytics](/observability/analytics) dashboard for aggregate call counts, or browse Traffic Logs sorted by tool name to see the call distribution.
