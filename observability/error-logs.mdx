...
**Error context**: The primary error information. MCPCore extracts the error message intelligently, parsing JSON responses when available and falling back to raw text:
