...
Save the config file. VS Code picks up MCP configuration changes automatically, though you may need to open a new chat to see the updated tools.
...
| `401 Unauthorized` | Verify the header name and value match your server's security mode |
